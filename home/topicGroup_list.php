...
<!-- To allow only admin to access the content -->      
    <div class="box box-primary">
		...
		<label class="box-title">รายการ กลุ่มหัวข้อการประเมิน</label>


			<a href="<?=$rootPage;?>_data.php?id=" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> เพิ่ม กลุ่มหัวข้อการประเมิน</a>
				...
				<form id="form1" action="<?=$rootPage;?>_list.php" method="get" class="form" novalidate>
					<div class="col-md-6">
						<div class="form-group">
	                        <label for="search_word">บางส่วนของ ชื่อกลุ่มหัวข้อการประเมิน เพื่อใช้ค้นหาข้อมูล</label>
           ...
           ?> 
            ...
            <table class="table table-striped">
                <tr style="background-color: #ffcc99;">
					<th>ลำดับ</th>
					<th>รหัส</th>
					<th>ชื่อกลุ่มหัวข้อการประเมิน</th>
                    <th>สถานะ</th>
                    <th>#</th>
                </tr>
